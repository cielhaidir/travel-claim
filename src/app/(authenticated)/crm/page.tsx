...
export default function CrmPage() {
  ...
  const isAllowed =
    session?.user?.isRoot === true || hasAnyRole(userRoles, CRM_ROLES);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        primaryAction={{ label: "Tambah Lead", onClick: openCreateLead }}
        secondaryAction={{ label: "Tambah Customer", onClick: openCreateCustomer }}
      />
          ...
          <div className="grid gap-4 xl:grid-cols-6">
            {pipelineSummary.map((group) => (
              <div
                ...
                onDrop={() => void handleDropLead(group.stage)}
              >
                  ...
                  {group.items.length === 0 ? (
                    ...
                    group.items.map((lead) => (
                      <div
                        ...
                        className={cn(
                          "cursor-move rounded-xl border border-gray-200 p-3",
