...
const DEFAULT_COA_TEMPLATE: CoaTemplate[] = [
  ...
  },
  {
    ...
    subcategory: "Piutang",
    parentCode: "1130",
    description: "Piutang kepada customer atas invoice penjualan barang dan jasa",
  },
  {
    code: "2000",
  ...
  },
  {
    ...
    accountType: COAType.REVENUE,
    category: "Pendapatan",
    description: "Kelompok akun pendapatan utama perusahaan",
  },
  {
    code: "4100",
    ...
    parentCode: "4000",
    description: "Pendapatan dari penjualan hardware dan barang dagang",
  },
  {
    code: "4200",
    ...
    subcategory: "Jasa",
    parentCode: "4000",
    description: "Pendapatan dari penjualan jasa implementasi, lisensi, dan managed service",
  },
  {
    code: "6000",
